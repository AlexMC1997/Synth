...
public class GUIPane extends JFrame implements Runnable {
	...
	public void run() {
        ...
        tf5.addMouseWheelListener(new MouseWheelListener() {
			...
			public void mouseWheelMoved(MouseWheelEvent e) {
				if (mtf5) {
					...
					rootf = (d < 0 ) || ( d > 11600 ) ? rootf : Double.parseDouble(df.format(d));
        ...
        tf6.addMouseWheelListener(new MouseWheelListener() {
			...
			public void mouseWheelMoved(MouseWheelEvent e) {
				if (mtf6) {
					...
					harm1f = (d < 0 ) || ( d > 11600 ) ? harm1f : Double.parseDouble(df.format(d));
					Oscillator.WaveProfile wp = mixer.getProfile();
					wp.setHarm1f(harm1f);
					mixer.setProfile(wp);;					
        ...
        tf7.addMouseWheelListener(new MouseWheelListener() {
			...
			public void mouseWheelMoved(MouseWheelEvent e) {
				if (mtf7) {
					...
					harm2f = (d < 0 ) || ( d > 11600 ) ? harm2f : Double.parseDouble(df.format(d));
					Oscillator.WaveProfile wp = mixer.getProfile();
					wp.setHarm2f(harm2f);
					mixer.setProfile(wp);;					
        ...
        tf8.addMouseWheelListener(new MouseWheelListener() {
			...
			public void mouseWheelMoved(MouseWheelEvent e) {
				if (mtf8) {
					...
					harm3f = (d < 0 ) || ( d > 11600 ) ? harm3f : Double.parseDouble(df.format(d));
					Oscillator.WaveProfile wp = mixer.getProfile();
					wp.setHarm3f(harm3f);
					mixer.setProfile(wp);;					
        ...
        ImageIcon m = new ImageIcon(getClass().getResource("/Spike.png"));  
